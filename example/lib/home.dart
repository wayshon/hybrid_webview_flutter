...
const _DETAIL_URL =
    "https://calcbit.com/resource/flutter/hybrid_webview_flutter/fe-file/detail.html";
...
class HomeState extends State<Home> {
  ...
  void initState() {
    ...
    webView = new HybridWebview(
        url: '$_HOME_URL?t=${new DateTime.now().millisecondsSinceEpoch}',
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: GestureDetector(
                          onTap: jumpDetail, child: Text('jump detail')))
                ],
              ))),
    );
  }
  ...
  jumpDetail() {
    Navigator.of(context).push(new MaterialPageRoute(builder: (context) {
      return new Detail(url: _DETAIL_URL);
    }));
  }
}
